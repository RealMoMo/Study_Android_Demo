...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
		...
		// added by lmc in 2017/7/28 for [Settings.Secure.SHOW_IME_WITH_HARD_KEYBOARD]
		loadIntegerSetting(stmt, Settings.Secure.SHOW_IME_WITH_HARD_KEYBOARD,
                   R.integer.def_show_ime_with_hard_keyboard);
		// end added by lmc in 2017/7/28 for [Settings.Secure.SHOW_IME_WITH_HARD_KEYBOARD]

		// added by lmc in 2017/6/20 for [ime]
		if("zh".equals(SystemProperties.get("persist.sys.language", "en"))){                             
           if("TW".equals(SystemProperties.get("persist.sys.country", "US"))){
       			loadStringSetting(stmt, Settings.Secure.DEFAULT_INPUT_METHOD,R.string.config_taiwan_input_method);
           }else{
       			loadStringSetting(stmt, Settings.Secure.DEFAULT_INPUT_METHOD,R.string.config_chinese_input_method);                                       
           }                   
   		}else if("ko".equals(SystemProperties.get("persist.sys.language", "en"))){
			loadStringSetting(stmt, Settings.Secure.DEFAULT_INPUT_METHOD,R.string.config_korea_input_method);                 
   		}else{
		...
		// end added by lmc in 2017/6/20 for [ime]
        } finally {
            if (stmt != null) stmt.close();
        }
    }
